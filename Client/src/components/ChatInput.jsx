...
const ChatInput = ({ handleSendMsg }) => {
  ...
  return (
    <div className="grid grid-col-[5%,95%] items-center py-1 pb-2">
      <div className="flex items-center text-white gap-4">
        <div className=" relative">
          ...
          {showEmojiPicker && (
            <Picker
              className="absolute top-[-350px] bg-[#080420] border-[#9a86f3] shadow-md"
              onEmojiClick={handleEmojiClick}
              pickerStyle={pickerStyle}
              emojiScrollWrapperStyle={{
                "&::-webkit-scrollbar": {
      ...
      <form
        className="w-screen rounded-full flex items-center gap-8 bg-[#ffffff34]"
